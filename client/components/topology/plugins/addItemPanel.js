...
class AddItemPanel {
  ...
  initPlugin(graph) {
    ...
    const children = parentNode.querySelectorAll('div > .act-collapse > .act-collapse-item > .act-collapse-content > .act-collapse-content-box > img[data-item]')
    console.warn('children:', children)
    each(children, (child, i) => {
      const addModel = (new Function("return " + child.getAttribute('data-item')))()
      console.warn('addModel:', addModel)
